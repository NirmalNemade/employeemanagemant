...
public class PermissionMapping {
    ...
    private static final Map<Role, Set<Permission>> map = Map.of(
            ...
            Role.ADMIN, Set.of(Permission.POST_CREATE, Permission.USER_UPDATE, Permission.POST_UPDATE, Permission.USER_DELETE, Permission.USER_CREATE, Permission.POST_DELETE)
    );
